				...
				<form action="">
					<div class="grid w-full grid-cols-1 gap-4">
						<div class="grid w-full grid-cols-2 gap-4">
							...
							<label>
								<input name="last_name" type="text" placeholder="Last name" class="input w-full" />
							</label>
						</div>
						<label>
						...
						<div class="grid w-full grid-cols-2 gap-4">
							<label>
								<input name="password" {type} placeholder="Password" class="input w-full" />
							</label>
						...
						<button type="button" class=" btn text-lg font-bold btn-primary"> Sign Up </button>
					</div>
				</form>
