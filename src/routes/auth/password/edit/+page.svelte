		...
		<div class="w-full">
			{#if form?.success}
				<div class="w-full" in:fly={{ x: -325, duration: 500 }}>
					<h1 class=" mb-[18px] text-3xl font-bold text-primary">Password Updated</h1>
					<p class=" text-xl text-primary">
						You have Updated user password<br />
						Please login with new password.
					</p>

					<a
						href="/auth/login"
						class=" btn mt-6 btn-wide max-w-[120px] text-lg font-bold btn-secondary"
					>
						Close
					</a>
				</div>
			{:else}
				<div class="w-full max-w-[350px]" in:fly={{ x: -325, duration: 500 }}>
					<h1 class=" mb-[18px] text-3xl font-bold text-primary">Create New Password.</h1>
					<p class=" text-xl text-primary">
